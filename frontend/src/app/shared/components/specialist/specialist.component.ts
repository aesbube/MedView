...
export class SpecialistComponent {
  ...
  ngOnInit() {
    this.specialistId = this.route.snapshot.params['id'];
    console.log('Helelo');
  ...
  getSpecialist(): Observable<Specialist> {
    return this.http.get<Specialist>(
      `${this.apiUrl}/specialists/${this.specialistId}`
    );
  }

  getSchedule(): Observable<Schedule> {
    return this.http.get<Schedule>(
      `${this.apiUrl}/specialists/schedule?specialistId=${this.specialistId}`
    );
  }
